...
export const strings = {
  zh: {
    ...
    setSecGeneral: '通用',
    setSecAbout: '关于',
    forkBasedOn: '基于 GenOffice (Apache-2.0) 二次开发',
    setSecAi: 'AI',
    setAiProvider: '服务商',
    setAiApiKey: 'API Key',
    setAiBaseUrl: '接口地址 (Base URL)',
    setAiModel: '模型',
    setAiHelp: '填入服务商的 API Key 即可使用 AI 功能。智谱(Custom)、OpenAI、Anthropic 等均支持。',
    setAiKeyHint: '留空则该服务商不可用',
    setAiCustomHint: 'Custom 服务商需填写 Base URL',
    setAiModelHint: '自定义模型名(留空用默认)',
    setAiSaved: '已保存',
    setAiPreset: '快速模板',
    setAiPresetChoose: '选择预设…',
    setAiTestBtn: '测试连接',
    setAiTesting: '测试中…',
    setAiTestOk: '✓ 连接成功',
    setAiTestFail: '✗ 连接失败',
  ...
  en: {
    ...
    setSecAbout: 'About',
    forkBasedOn: 'Fork of GenOffice (Apache-2.0)',
    setSecAi: 'AI',
    setAiProvider: 'Provider',
    setAiApiKey: 'API Key',
    setAiBaseUrl: 'Base URL',
    setAiModel: 'Model',
    setAiHelp: 'Enter the API key for the selected provider to enable AI features. Zhipu (Custom), OpenAI, Anthropic, etc. are supported.',
    setAiKeyHint: 'Leave empty to disable this provider',
    setAiCustomHint: 'Custom provider requires a Base URL',
    setAiModelHint: 'Custom model name (leave empty for default)',
    setAiSaved: 'Saved',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
  ...
  ja: {
    ...
    setAiBaseUrl: 'ベースURL',
    setAiModel: 'モデル',
    setAiHelp: '選択したプロバイダーのAPIキーを入力してAI機能を有効化。',
    setAiKeyHint: '空欄で無効',
    setAiCustomHint: 'CustomはベースURLが必要',
    setAiModelHint: 'カスタムモデル名',
    setAiSaved: '保存済み',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
  ...
  ko: {
    ...
    setAiBaseUrl: 'Base URL',
    setAiModel: '모델',
    setAiHelp: '선택한 제공자의 API 키를 입력하세요.',
    setAiKeyHint: '비워두면 비활성화',
    setAiCustomHint: 'Custom은 Base URL 필요',
    setAiModelHint: '사용자 모델 이름',
    setAiSaved: '저장됨',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
  ...
  fr: {
    ...
    setAiModel: 'Modèle',
    setAiHelp: 'Saisissez la clé API du fournisseur sélectionné.',
    setAiKeyHint: 'Vide pour désactiver',
    setAiCustomHint: 'Custom nécessite une URL',
    setAiModelHint: 'Nom de modèle personnalisé',
    setAiSaved: 'Enregistré',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Connexion OK',
    setAiTestFail: '✗ Échec de connexion',
    setEmail: 'E-mail',
  ...
  de: {
    ...
    setAiModel: 'Modell',
    setAiHelp: 'Geben Sie den API-Schlüssel ein.',
    setAiKeyHint: 'Leer zum Deaktivieren',
    setAiCustomHint: 'Custom erfordert URL',
    setAiModelHint: 'Benutzerdefinierter Modellname',
    setAiSaved: 'Gespeichert',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Verbindung OK',
  ...
  es: {
    ...
    setAiModel: 'Modelo',
    setAiHelp: 'Ingrese la clave API del proveedor.',
    setAiKeyHint: 'Vacío para desactivar',
    setAiCustomHint: 'Custom requiere URL',
    setAiModelHint: 'Nombre de modelo personalizado',
    setAiSaved: 'Guardado',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Conexión OK',
    setAiTestFail: '✗ Conexión fallida',
  ...
  th: {
    ...
    setAiBaseUrl: 'URL หลัก',
    setAiModel: 'โมเดล',
    setAiHelp: 'ป้อนคีย์ API ของผู้ให้บริการ',
    setAiKeyHint: 'ว่างเพื่อปิด',
    setAiCustomHint: 'Custom ต้องมี URL',
    setAiModelHint: 'ชื่อโมเดลกำหนดเอง',
    ...
    setAiTestFail: '✗ เชื่อมต่อล้มเหลว',
    setEmail: 'อีเมล',
  ...
  id: {
    ...
    setAiBaseUrl: 'URL Dasar',
    setAiModel: 'Model',
    setAiHelp: 'Masukkan kunci API penyedia.',
    setAiKeyHint: 'Kosongkan untuk menonaktifkan',
    setAiCustomHint: 'Custom memerlukan URL',
    setAiModelHint: 'Nama model kustom',
    setAiSaved: 'Tersimpan',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Koneksi OK',
  ...
  ru: {
    ...
    setAiModel: 'Модель',
    setAiHelp: 'Введите API-ключ провайдера.',
    setAiKeyHint: 'Пусто для отключения',
    setAiCustomHint: 'Custom требует URL',
    setAiModelHint: 'Пользовательское имя модели',
    setAiSaved: 'Сохранено',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Подключение ОК',
  ...
  ar: {
    ...
    setSecAbout: 'حول',
    forkBasedOn: 'Fork of GenOffice (Apache-2.0)',
    setSecAi: 'الذكاء الاصطناعي',
    setAiProvider: 'المزود',
    setAiApiKey: 'مفتاح API',
    setAiBaseUrl: 'الرابط الأساسي',
    setAiModel: 'النموذج',
    setAiHelp: 'أدخل مفتاح API للمزود المحدد.',
    setAiKeyHint: 'اتركه فارغًا للتعطيل',
    setAiCustomHint: 'Custom يتطلب رابطًا',
    setAiModelHint: 'اسم نموذج مخصص',
    setAiSaved: 'تم الحفظ',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ الاتصال ناجح',
  ...
  pt: {
    ...
    setAiApiKey: 'Chave API',
    setAiBaseUrl: 'URL base',
    setAiModel: 'Modelo',
    setAiHelp: 'Insira a chave API do provedor.',
    setAiKeyHint: 'Vazio para desativar',
    setAiCustomHint: 'Custom requer URL',
    setAiModelHint: 'Nome de modelo personalizado',
    setAiSaved: 'Salvo',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Conexão OK',
    setAiTestFail: '✗ Conexão falhou',
    setEmail: 'E-mail',
  ...
  it: {
    ...
    setAiModel: 'Modello',
    setAiHelp: 'Inserisci la chiave API del provider.',
    setAiKeyHint: 'Vuoto per disattivare',
    setAiCustomHint: 'Custom richiede URL',
    setAiModelHint: 'Nome modello personalizzato',
    setAiSaved: 'Salvato',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Connessione OK',
    setAiTestFail: '✗ Connessione fallita',
    setEmail: 'Email',
  ...
  pl: {
    ...
    setAiModel: 'Model',
    setAiHelp: 'Wprowadź klucz API dostawcy.',
    setAiKeyHint: 'Puste, aby wyłączyć',
    setAiCustomHint: 'Custom wymaga URL',
    setAiModelHint: 'Niestandardowa nazwa modelu',
    setAiSaved: 'Zapisano',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Połączenie OK',
  ...
  nl: {
    ...
    forkBasedOn: 'Fork of GenOffice (Apache-2.0)',
    setSecAi: 'AI',
    setAiProvider: 'Aanbieder',
    setAiApiKey: 'API-sleutel',
    setAiBaseUrl: 'Basis-URL',
    setAiModel: 'Model',
    setAiHelp: 'Voer de API-sleutel in.',
    setAiKeyHint: 'Leeg om uit te schakelen',
    setAiCustomHint: 'Custom vereist URL',
    setAiModelHint: 'Aangepaste modelnaam',
    setAiSaved: 'Opgeslagen',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Verbinding OK',
  ...
  ms: {
    ...
    setAiModel: 'Model',
    setAiHelp: 'Masukkan kunci API penyedia.',
    setAiKeyHint: 'Kosongkan untuk lumpuhkan',
    setAiCustomHint: 'Custom memerlukan URL',
    setAiModelHint: 'Nama model tersuai',
    setAiSaved: 'Disimpan',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ Sambungan OK',
  ...
  he: {
    ...
    setAiModel: 'מודל',
    setAiHelp: 'הזן את מפתח ה-API של הספק.',
    setAiKeyHint: 'ריק כדי להשבית',
    setAiCustomHint: 'Custom דורש כתובת',
    setAiModelHint: 'שם מודל מותאם אישית',
    setAiSaved: 'נשמר',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
    setAiTesting: 'Testing…',
    setAiTestOk: '✓ חיבור תקין',
    setAiTestFail: '✗ חיבור נכשל',
    setEmail: 'אימייל',
  ...
  hi: {
    ...
    setAiApiKey: 'एपीआई कुंजी',
    setAiBaseUrl: 'बेस यूआरएल',
    setAiModel: 'मॉडल',
    setAiHelp: 'चयनित प्रदाता की एपीआई कुंजी दर्ज करें।',
    setAiKeyHint: 'अक्षम करने के लिए खाली छोड़ें',
    setAiCustomHint: 'Custom को यूआरएल चाहिए',
    setAiModelHint: 'कस्टम मॉडल नाम',
  ...
  'zh-TW': {
    ...
    setSecGeneral: '一般',
    setSecAbout: '關於',
    forkBasedOn: '基於 GenOffice (Apache-2.0) 二次開發',
    setSecAi: 'AI',
    setAiProvider: '服務商',
    setAiApiKey: 'API 金鑰',
    setAiBaseUrl: '基礎網址',
    setAiModel: '模型',
    setAiHelp: '填入服務商的 API 金鑰即可使用 AI 功能。',
    setAiKeyHint: '留空則停用',
    setAiCustomHint: 'Custom 需填寫基礎網址',
    setAiModelHint: '自訂模型名稱',
    setAiSaved: '已儲存',
    setAiPreset: 'Quick Preset',
    setAiPresetChoose: 'Choose a preset…',
    setAiTestBtn: 'Test Connection',
